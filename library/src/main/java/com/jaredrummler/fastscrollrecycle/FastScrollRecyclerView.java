...
public class FastScrollRecyclerView extends RecyclerView implements RecyclerView.OnItemTouchListener {
    ...
    public void updateStartPosition(int scrollX){
    ...
    protected void synchronizeScrollBarThumbOffsetToViewScroll(ScrollPositionState scrollPosState, int rowCount) {
        ...
        if(isSqlScan){
            fastScrollBar.setThumbOffset(getMinimumWidth() - 28 + offSet, scrollBarY);
        }else {
    ...
    public void onUpdateScrollbar(int dy) {
        try {
            ...
            if (getLayoutManager() instanceof GridLayoutManager) {
                ...
                rowCount = (int) Math.ceil((double) rowCount / spanCount) - 1;
            }
